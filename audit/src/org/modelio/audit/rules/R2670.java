...
public class R2670 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Metamodel.getMClass(DeepHistoryPseudoState.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(ShallowHistoryPseudoState.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
