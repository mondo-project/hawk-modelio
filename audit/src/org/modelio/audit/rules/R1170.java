...
public class R1170 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(CallOperationAction.class).getName(), this,
                AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(InputPin.class).getName(), this, AuditTrigger.UPDATE
                | AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(Operation.class).getName(), this, AuditTrigger.MOVE);
    }
