...
public class R1830 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(PartDecomposition.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(Message.class).getName(), this, AuditTrigger.CREATE |
                                                        AuditTrigger.MOVE |
                                                        AuditTrigger.UPDATE);
    }
