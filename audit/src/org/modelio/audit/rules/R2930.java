...
public class R2930 extends AbstractRule {
    ...
    public void autoRegister(final IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(Message.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(CommunicationMessage.class).getName(), this, AuditTrigger.CREATE |
                                                                     AuditTrigger.UPDATE);
    }
