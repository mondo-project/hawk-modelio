...
public class GroupFigure extends GradientFigure {
    ...
    public GroupFigure(boolean stretchLastChild) {
        ...
        // The element list itself is a vertical FlowLayout figure
        ...
        ToolbarLayout layout = stretchLastChild ? new ToolbarLayoutWithGrab() : new ToolbarLayout();
    ...
    private GridData createElementListGridData() {
        return new GridData(SWT.FILL, SWT.FILL, true, true);
    }

    @objid ("7e5bbfa6-1dec-11e2-8cad-001ec947c8cc")
    private GridData createIndicatorGridData() {
