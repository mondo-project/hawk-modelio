...
public class R2810 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Metamodel.getMClass(DeepHistoryPseudoState.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(ShallowHistoryPseudoState.class).getName(), this, AuditTrigger.UPDATE);
    }
