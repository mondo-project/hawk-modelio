...
public class ExpansionRegionEditPart extends GmNodeEditPart {
    ...
    protected void refreshVisuals() {
        GmExpansionRegionPrimaryNode expansionregionModel = (GmExpansionRegionPrimaryNode) this.getModel();
        this.getFigure().getParent().setConstraint(this.getFigure(), expansionregionModel.getLayoutData());
    }
