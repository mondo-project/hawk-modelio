...
/**
 * Handler for the setHorizontalLayout command, using injection to execute on the {@link NotesView} MPart.
 * Changes the property view layout to horizontal.
 * @see SetNoteVtLayoutHandler
 * @see SetNoteAutoLayoutHandler
 */
@objid ("26dec2e9-186f-11e2-bc4e-002564c97630")
public class SetNoteHzLayoutHandler {
    @objid ("26dec2eb-186f-11e2-bc4e-002564c97630")
    @Execute
    public void execute(@Named(IServiceConstants.ACTIVE_PART) final MPart e) {
        if (e.getObject() instanceof NotesView) {
            ...
            view.getNotesPanel().setHorizontalLayout();
        }
    }
