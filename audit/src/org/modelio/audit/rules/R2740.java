...
public class R2740 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(TemplateBinding.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(TemplateParameterSubstitution.class).getName(), this, AuditTrigger.CREATE |
                                                                              AuditTrigger.UPDATE);
    }
