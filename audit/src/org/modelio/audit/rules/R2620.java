...
public class R2620 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(State.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(EntryPointPseudoState.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(ExitPointPseudoState.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
