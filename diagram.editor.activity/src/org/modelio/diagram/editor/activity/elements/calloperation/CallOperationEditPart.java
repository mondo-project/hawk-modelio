...
public class CallOperationEditPart extends GmNodeEditPart {
    ...
    protected void addChildVisual(EditPart childEditPart, int index) {
        ...
        if (index == 0 && gmAbstractObject.getLayoutData() == null) {
            ...
            throw new IllegalArgumentException("CallOperationEditPart#addChildVisual: unknown index " + index);
        }
    ...
    protected void refreshVisuals() {
        GmCallOperationPrimaryNode calloperationModel = (GmCallOperationPrimaryNode) this.getModel();
