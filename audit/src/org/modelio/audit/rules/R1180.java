...
public class R1180 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        //ObjectNode
        plan.registerRule(Metamodel.getMClass(ExpansionNode.class).getName(), this, AuditTrigger.UPDATE);
        ...
        plan.registerRule(Metamodel.getMClass(ActivityParameterNode.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(CentralBufferNode.class).getName(), this, AuditTrigger.UPDATE);
    }
