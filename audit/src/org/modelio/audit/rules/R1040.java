...
public class R1040 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(ActivityParameterNode.class).getName(), this, AuditTrigger.CREATE |
                                                                      AuditTrigger.MOVE |
                                                                      AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(BehaviorParameter.class).getName(), this, AuditTrigger.MOVE);
    }
