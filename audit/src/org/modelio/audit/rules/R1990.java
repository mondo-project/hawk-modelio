...
public class R1990 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Metamodel.getMClass(Attribute.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(AssociationEnd.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
        
        plan.registerRule(Metamodel.getMClass(Generalization.class).getName(), this, AuditTrigger.CREATE |
                                                               AuditTrigger.MOVE |
                                                               AuditTrigger.UPDATE);
    }
