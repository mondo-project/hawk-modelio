...
public class E245Checker implements IChecker {
    ...
    public void register(final Plan plan) {
        ...
        plan.registerChecker(this, Metamodel.getMClass(BindableInstance.class), TriggerType.Create, null);
        
        // trigger=create, metaclass=BindableInstance, feature=Cluster
        plan.registerChecker(this, Metamodel.getMClass(BindableInstance.class), TriggerType.Create, "Cluster");
        
        // trigger=create, metaclass=BindableInstance, feature=InternalOwner
        plan.registerChecker(this, Metamodel.getMClass(BindableInstance.class), TriggerType.Create, "InternalOwner");
        
        // trigger=create, metaclass=BindableInstance, feature=Owner
        plan.registerChecker(this, Metamodel.getMClass(BindableInstance.class), TriggerType.Create, "Owner");
    }
