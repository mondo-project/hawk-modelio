...
public class R2260 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Metamodel.getMClass(Operation.class).getName(), this, AuditTrigger.CREATE |
                                                          AuditTrigger.UPDATE |
                                                          AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(TemplateParameter.class).getName(), this, AuditTrigger.CREATE |
                                                                  AuditTrigger.UPDATE |
                                                                  AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(Parameter.class).getName(), this, AuditTrigger.CREATE |
                                                          AuditTrigger.UPDATE |
                                                          AuditTrigger.MOVE);
    }
