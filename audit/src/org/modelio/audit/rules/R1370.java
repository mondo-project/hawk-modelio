...
public class R1370 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(OutputPin.class).getName(), this, AuditTrigger.CREATE |
                                                          AuditTrigger.MOVE |
                                                          AuditTrigger.UPDATE);
        
        // ActivityEdge
        plan.registerRule(Metamodel.getMClass(ObjectFlow.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(ControlFlow.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(MessageFlow.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
