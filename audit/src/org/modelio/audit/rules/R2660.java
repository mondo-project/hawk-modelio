...
public class R2660 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Metamodel.getMClass(State.class).getName(), this, AuditTrigger.UPDATE | AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(InternalTransition.class).getName(), this, AuditTrigger.CREATE);
    }
