...
public class R1380 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(SendSignalAction.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(Signal.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(Attribute.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
        plan.registerRule(Metamodel.getMClass(InputPin.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE | AuditTrigger.UPDATE);
    }
