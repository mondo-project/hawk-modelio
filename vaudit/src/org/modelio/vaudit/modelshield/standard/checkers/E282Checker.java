...
public class E282Checker implements IChecker {
    ...
    public void register(final Plan plan) {
        ...
        plan.registerChecker(this, Metamodel.getMClass(Dependency.class), TriggerType.Update, "Impacted");
        
        // trigger=*, metaclass=Dependency, feature=DependsOn
        plan.registerChecker(this, Metamodel.getMClass(Dependency.class), TriggerType.Update, "DependsOn");
        
        // trigger=create, metaclass=Dependency, feature=null
        plan.registerChecker(this, Metamodel.getMClass(Dependency.class), TriggerType.Create, null);
    }
