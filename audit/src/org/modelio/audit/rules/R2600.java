...
public class R2600 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        ...
        plan.registerRule(Metamodel.getMClass(Region.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(State.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.UPDATE | AuditTrigger.MOVE);
    }
