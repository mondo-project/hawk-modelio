...
public class R2080 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(PropertyTable.class).getName(), this, AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(PropertyDefinition.class).getName(), this, AuditTrigger.CREATE |
                                                         AuditTrigger.MOVE |
                                                         AuditTrigger.UPDATE);
    }
