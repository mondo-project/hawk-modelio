...
/**
 * Specialisation of the default delegating policy to handle the Partition specific tools like
 * "create sibling partition", "create inner partition" and "create partition container".
 * 
 * @author fpoyer
 */
