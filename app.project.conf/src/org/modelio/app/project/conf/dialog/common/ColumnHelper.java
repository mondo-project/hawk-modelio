    ...
    public static TableViewerColumn createFragmentMmVersionColumn(TableViewer viewer) {
        ...
        mmVer.setLabelProvider(new ColumnLabelProvider() {
            ...
            public String getText(Object element) {
                if (element instanceof IProjectFragment) {
                    try {
                        return ((IProjectFragment) element).getMetamodelVersion().toString();
                    } catch (IOException e) {
            ...
            public String getToolTipText(Object element) {
                if (element instanceof IProjectFragment) {
                    try {
                        return AppProjectConf.I18N.getMessage("Column.fragmentMmVersion.val.tooltip", ((IProjectFragment) element).getMetamodelVersion().toString());
                    } catch (IOException e) {
                        return FileUtils.getLocalizedMessage(e);
                    }
                }
