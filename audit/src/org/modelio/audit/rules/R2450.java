...
public class R2450 extends AbstractRule {
    ...
    public void autoRegister(IAuditPlan plan) {
        plan.registerRule(Metamodel.getMClass(Package.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.UPDATE);
        plan.registerRule(Metamodel.getMClass(Generalization.class).getName(), this, AuditTrigger.CREATE | AuditTrigger.MOVE);
    }
